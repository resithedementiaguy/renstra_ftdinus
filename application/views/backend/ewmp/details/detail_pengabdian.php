    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Detail Pengabdian</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header text-white bg-success">
                        <h5 class="pt-2"><strong>Detail Pelaporan EWMP - Pengabdian</strong></h5>
                    </div>
                    <div class="card-body">
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            Silahkan untuk mengecek detail pelaporan pengabdian Fakultas Teknik UDINUS Semarang
                        </div>
                        <div class="d-flex justify-content-between">
                            <a href="<?= base_url('ewmp/edit_pelaporan/' . $pelaporan['id']) ?>" type="button" class="btn btn-warning mb-4">
                                <i class="bi bi-pencil"></i> <strong>Edit Pengabdian</strong>
                            </a>
                        </div>
