                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <th>Nama Pengusul</th>
                                    <td><?= htmlspecialchars($reviewer_jurnal['nama_usul']) ?></td>
                                </tr>
                                <tr>
                                    <th>Program Studi</th>
                                    <td><?= htmlspecialchars($reviewer_jurnal['prodi']) ?></td>
                                </tr>
                                <tr>
                                    <th>Judul Artikel yang telah direview</th>
                                    <td><?= htmlspecialchars($reviewer_jurnal['judul_artikel']) ?></td>
                                </tr>
                                <tr>
                                    <th>Judul Jurnal</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= $reviewer_jurnal['sertifikat'] ?>" target="_blank" class="btn btn-primary">
