        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('ewmp/update_editor_jurnal/' . $editor_jurnal['id_pelaporan']) ?>" method="post">
                            <div class="row mb-3">
                                <label for="nama_usul" class="col-sm-2 col-form-label">Nama Pengusul</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama_usul" name="nama_usul" value="<?= htmlspecialchars($editor_jurnal['nama_usul']) ?>" required>
                                </div>
                            </div>
                            <fieldset class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="prodi" id="prodi1" value="Teknik Elektro" <?php echo (isset($editor_jurnal['prodi']) && $editor_jurnal['prodi'] === 'Teknik Elektro') ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="prodi1">Teknik Elektro</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="prodi" id="prodi2" value="Teknik Industri" <?php echo (isset($editor_jurnal['prodi']) && $editor_jurnal['prodi'] === 'Teknik Industri') ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="prodi2">Teknik Industri</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="prodi" id="prodi3" value="Teknik Biomedis" <?php echo (isset($editor_jurnal['prodi']) && $editor_jurnal['prodi'] === 'Teknik Biomedis') ? 'checked' : ''; ?>>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="judul" name="judul" rows="3" required><?= htmlspecialchars($editor_jurnal['judul']) ?></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="file_sk" class="col-sm-2 col-form-label">Link Google Drive SK</label>
                                <div class="col-sm-10">
                                    <input type="url" class="form-control" id="file_sk" name="file_sk" value="<?= $editor_jurnal['file_sk'] ?>">
                                </div>
                            </div>
                            <div class="text-end">
